...
mod integrals {
    ...
    fn zero() {
        ...
        assert_eq!(
            integrate(&[0, 0, 0], 1usize),
            [1, 0, 0, 0]
        );
    }
    #[test]
    fn one() { assert_eq!(integrate(&[1,0,0],1),[1,1,0,0]) }
    #[test]
    fn quadratic() { assert_eq!(integrate(&[0,0,3],1),[1,0,0,1]) }
    #[test]
...
mod companion {
    ...
    fn monic_quadratic() {
        ...
        assert_eq!(companion(&[10_i8,5_i8,1_i8]),[[-5_i8,-10_i8],[1_i8,0_i8]]);
    }
...
//     #[test]
//     fn zero() {
//         assert_eq!(roots(&[0,0]), Ok([Complex::zero()]));
//     }
//     #[test]
//     fn one() {
//         assert_eq!(roots(&[1,0]), Ok([Complex::one()]));
//     }
// }