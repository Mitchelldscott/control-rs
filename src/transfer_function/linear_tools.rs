...
//!
use nalgebra::{allocator::Allocator, Complex, Const, DefaultAllocator, DimDiff, DimSub, OMatrix, RealField, U1};
...
pub fn poles<T, const M: usize, const N: usize>(tf: &TransferFunction<T, M, N>) -> Option<OMatrix<Complex<T>, Const<N>, U1>>
where
